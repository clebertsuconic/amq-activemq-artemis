...
public class RefsOperation extends TransactionOperationAbstract {
   ...
   private boolean decDelivering = true;
   ...
   public RefsOperation setDecDelivering(boolean decDelivering) {
      this.decDelivering = decDelivering;
      return this;
   }

   public boolean isDecDelivering() {
      return decDelivering;
   }
   ...
   public void afterCommit(final Transaction tx) {
      for (MessageReference ref : refsToAck) {
         ...
         synchronized (ref.getQueue()) {
            ref.getQueue().postAcknowledge(ref, reason, decDelivering);
         }
      }
